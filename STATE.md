...
MailDomain creation, and Subscription creation. The CLI login/session flow,
...
Add the first authenticated CLI command for reading MailDomain resources; do
